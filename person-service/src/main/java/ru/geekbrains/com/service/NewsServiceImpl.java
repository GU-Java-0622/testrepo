...
import ru.geekbrains.com.entity.Status;
import ru.geekbrains.com.exceptions.ResourceNotFoundException;
import ru.geekbrains.com.dto.news.NewsDtoRequest;
import ru.geekbrains.com.dto.news.NewsDtoResponse;
import ru.geekbrains.com.repository.NewsRepository;
...
public class NewsServiceImpl implements NewsService{
    private final String GET_LAST_FOUR_NEWS ="select new ru.geekbrains.com.dto.news.NewsDtoResponse" +
   ...
   public void delete(Long id){
    ...
    @Transactional
   public NewsDtoResponse saveOrUpdate(NewsDtoRequest newsDtoRequest){
       News news;
    ...
    public List<NewsDtoResponse> getNewsForWelcomePage() {
        ...
        query.setParameter("param", Status.ACTIVE);
